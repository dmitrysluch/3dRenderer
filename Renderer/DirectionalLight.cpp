...
DirectionalLight *DirectionalLight::InstantiateWithKernel(Kernel *kernel, string name, const Vector3f &direction,
                                                          const Vector3f &color) {
    auto light = new DirectionalLight(kernel, std::move(name), direction, color);
